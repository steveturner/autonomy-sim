...
fn entity(id: &str) -> RealDittoEntity {
    RealDittoEntity {
        entity_id: id.into(),
        peer_id: format!("ditto/{id}"),
    }
}

fn link(up: bool) -> RealDittoLink {
    RealDittoLink {
        source_entity_id: "alpha".into(),
        target_entity_id: "bravo".into(),
        source_peer_id: "ditto/alpha".into(),
        target_peer_id: "ditto/bravo".into(),
        up,
    }
}
